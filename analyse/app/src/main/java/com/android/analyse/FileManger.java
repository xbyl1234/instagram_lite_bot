...
public class FileManger {
    ...
    static public void CpyFile(Context context) {
        ...
        try {
            CpyFile(context.getApplicationInfo().nativeLibraryDir, "libpangle_faker.so", "/data/local/xdaddy");
        } catch (Throwable e) {
            Toast.makeText(context, "复制libpangle_faker失败: " + e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
