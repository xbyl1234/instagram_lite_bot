...
public class HookSubScreen2 extends ClassLoadCallBack {
    SubScreenImpl impl;

    public HookSubScreen2(AppFileWriter logFile) {
        super(logFile);
    }

    @Override
    public void OnLoadedClass(String clzName, Class clz, ClassLoader classLoader) {
        impl = new SubScreenImpl(logFile, "screen2", clz, classLoader);
    }
}
