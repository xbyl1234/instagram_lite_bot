...
public class HookSubScreen9 extends ClassLoadCallBack {
    SubScreenImpl impl;

    public HookSubScreen9(AppFileWriter logFile) {
        super(logFile);
    }

    @Override
    public void OnLoadedClass(String clzName, Class clz, ClassLoader classLoader) {
        impl = new SubScreenImpl(logFile, "screen9", clz, classLoader);
    }
}
